...
Security
Insights
JulieMwol/plugins/deepai.js /
@phaticusthiccy
phaticusthiccy 📢 WhatsAsena Version V1.2.3 is Available Now
…
Latest commit 175f9be on May 2
 History
 4 contributors
@phaticusthiccy@Xenon67@oguz162@lyfe00011
970 lines (642 sloc)  45.8 KB
...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'faceai', fromMe: true, deleteCommand: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by: Ask Your Mom'})
    ...
    Asena.addCommand({pattern: 'animai', fromMe: true, deleteCommand: false, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(
            ...
            MessageType.image, 
            {mimetype: Mimetype.jpg, caption: 'Made by: Ask Your Mom'}
        )
    ...
    Asena.addCommand({pattern: 'colorai', fromMe: true, deleteCommand: false, dontAddCommandList: true}, (async (message, match) => {    
        ...
        ffmpeg(location)
            ...
            .on('end', async () => {
                ...
                await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Made by: Ask Your Mom'})
